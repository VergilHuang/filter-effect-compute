...
export const FILTERS = [
  { id: 'gaussian-blur',      label: 'Gaussian Blur',       params: [{ key: 'radius',      label: 'Radius',      min: 1,    max: 50,   step: 1,   default: 10  }] },
  { id: 'edge-detection',     label: 'Edge Detection',      params: [] },
  { id: 'sharpen',            label: 'Sharpen',             params: [{ key: 'strength',    label: 'Strength',    min: 0.1,  max: 5,    step: 0.1, default: 1.5 }] },
  { id: 'grayscale',          label: 'Grayscale',           params: [] },
  { id: 'invert',             label: 'Invert',              params: [] },
  { id: 'brightness-contrast',label: 'Brightness/Contrast', params: [
  ...
  { id: 'pixelate',           label: 'Pixelate',            params: [{ key: 'blockSize',   label: 'Block Size',  min: 2,    max: 64,   step: 1,   default: 12  }] },
...
export function useImageProcessor() {
  ...
  function resetParams(filterId: FilterId = selectedFilter.value) {
    ...
    for (const param of def.params as any[]) p[param.key] = param.default
  ...
  function freeSabs() {
    ...
    // In a real Wasm scenario, we'd call Module._free() here.
